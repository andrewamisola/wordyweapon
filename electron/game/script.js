  ...
  modal.innerHTML = `
    <div style="background: #1f2937; border: 2px solid #ef4444; border-radius: 12px; padding: 24px; max-width: 500px; width: 90%; max-height: 80vh; overflow-y: auto;">
      ...
      <div style="display: flex; gap: 8px; flex-wrap: wrap;">
        ...
        <button id="bug-x-btn" style="flex: 1; min-width: 100px; padding: 10px 16px; background: #000; border: 1px solid #333; border-radius: 6px; color: white; cursor: pointer; font-size: 14px;">𝕏</button>
...
function createGrahamTree() {
  const p = 'gm';
  return {
    capstone: { id: 'cross_the_ts', name: "Cross the T's", desc: "Slash weapons: REREAD ×1" },
    nodes: [
      // Row 0: Start
      ...
      { id: `${p}_capstone`, name: "Duty Bound", type: "capstone", maxPoints: 1, row: 7, col: 2,
        desc: "Slash weapons: REREAD ×1", bonusPerPoint: 1, bonusType: "capstone", requires: [{id: `${p}_bladework`, points: 1}, {id: `${p}_titan`, points: 1}] },
    ]
  };
}
...
function createBelleTree() {
  const p = 'bl';
  return {
    capstone: { id: 'knowledge_eternal', name: "Knowledge Eternal", desc: "All words: REREAD ×1" },
    nodes: [
      // Row 0: Start
      ...
      { id: `${p}_capstone`, name: "Knowledge Eternal", type: "capstone", maxPoints: 1, row: 7, col: 2,
        desc: "All words: REREAD ×1", bonusPerPoint: 1, bonusType: "capstone", requires: [{id: `${p}_arcana`, points: 1}, {id: `${p}_duality`, points: 1}] },
    ]
  };
}
...
function createCaesuraTree() {
  const p = 'cs';
  return {
    capstone: { id: 'final_silence', name: "Final Silence", desc: "Words after an empty slot: ×2" },
    nodes: [
      // Row 0: Start
      ...
      { id: `${p}_capstone`, name: "Final Silence", type: "capstone", maxPoints: 1, row: 7, col: 2,
        desc: "Words after empty slot: ×2", bonusPerPoint: 1, bonusType: "capstone", requires: [{id: `${p}_assassinate`, points: 1}, {id: `${p}_execute`, points: 1}] },
    ]
  };
}
...
const HEROES=[
  ...
  },
  {
    ...
    good:"magic",
    bad:"slash",
    desc:"Princess of Verbia. The Erratum attacked while her parents were in Prosa—their fate unknown. Her first real fight.",
    dialogue:[
  ...
  },
  {
    ...
    good:"pierce",
    bad:"blunt",
    desc:"Emissary from Prosa. Brought warning of the Erratum—and news that the King and Queen's fate is unknown.",
    dialogue:[
      "...",
...
const HERO_ENEMY_DIALOGUE = {
  ...
  warrior: {
    ...
    idiomatic_undead: ["Great. A corpse that speaks in clichés. Just my luck.", "I've buried better conversationalists than you."],
    vulgar_vandal: ["I've heard enough. Shut up and fight.", "Back in my day, we had the decency to swear properly."],
    double_negative: ["You can't not die. Wait—you know what I mean.", "Two wrongs don't make you right."],
    ...
    silent_knight: "Finally. An enemy who doesn't talk. Your silence is the only respectable thing about you—but even respect won't save you from my blade.",
  ...
  ranger: {
    vowel_goblin: ["You used all five at once... wasteful.", "A, E, I, O, U—and none put to purpose."],
    ...
    silent_knight: "Silence. At least you understand that much. A quiet foe is rare—and still prey. Your armor cannot hide from my arrows.",
    cinna_antony: "You fight each other instead of the real enemy. That's why you'll both fall—divided resources, divided purpose, divided fate.",
    red_aktins: "You redact what you fear. But truth doesn't disappear—it waits. And I've gotten very good at waiting.",
    plague_doctor: "Imitation is theft dressed as flattery. You've taken the surface and missed the substance entirely.",
    oxy: "You call yourself a paradox, but you're just confused. Nature doesn't tolerate contradiction—it resolves it.",
  ...
  mage: {
    ...
    ghost: ["A phantom! How romantic, how tragic, how— wait, you're actually trying to hurt me? That's... that's quite rude, actually.", "Poor lost spirit. I'd offer sympathy, but you're in my way, and I don't have time for this."],
    synonym_roll: ["So many words for the same thing! I do that too, you know—when I'm avoiding something.", "Darling, repetition won't hide what you really mean. Trust me, I've tried."],
    ...
    pun_goblin: ["Oh, how clever! Wordplay to deflect! I would never— okay, fine, maybe I would. But I'm better at it.", "Your jokes are a lovely shield, darling. I wear one too. Shall we see whose cracks first?"],
    ...
    run_on_sentence: ["Oh my, you just keep going! It's almost impressive. When do you breathe? When do you stop and actually feel—never mind.", "All those words and none of them say what you really mean. I know the feeling."],
    ...
    mixed_metaphor: ["Your metaphors are all tangled up, dear. Your feelings too, I imagine. Not that I— this isn't about me.", "Such confusion! It's almost relatable. I said almost."],
    ...
    silent_knight: "Oh, the strong silent type! How mysterious, how brooding, how— you know what, I don't have to fill your silence for you. I do enough of that for myself.",
    ...
    oxy: "Contradictions everywhere! Living death, sweet sorrow, confident princess who definitely has her life together— wait, forget that last one. Just. Forget it.",
  ...
  paladin: {
    vowel_goblin: ["What hollow hoard is this, that grasps yet never gives? / My purpose calls: to free the voice that in your shadow lives.", "You clutch at letters like a drowning soul clutches driftwood. / Let go. I shall be your shore—as I was always meant to be."],
    ghost: ["O shade who walks 'tween meaning and the void— / My blade shall write the ending you've too long avoided.", "A whisper caught in amber, neither here nor hence. / My purpose is your peace. Without it, what am I?"],
    synonym_roll: ["A thousand words for one, yet silence speaks the truth. / My duty is to cut through noise—to carve meaning from uncouth.", "You spin your wheels of sameness, never moving, never still. / Stand aside, or learn what purpose means through steel and will."],
    comma_chameleon: ["Between the pause and breath, you hide from what must come. / But I? I am the sentence's end—the final, righteous sum.", "You hesitate where I cannot. The path is clear, the duty plain. / What would I be without this charge? ...No. Forward. Strike again."],
    webster_spiderling: ["You weave your web of meaning, trap truth in silken lies. / But justice cuts through gossamer—my oath shall be your demise.", "Definition is your prison, but purpose sets one free. / Without my sacred charge to keep... who would I even be?"],
    hyphen_hyena: ["Joined yet incomplete, your laughter rings so hollow. / I know the shape of purpose—and your emptiness I will not follow.", "Two halves a whole do not make when the center knows no creed. / My mission is my meaning. Yours? Just hunger. Just need."],
    pun_goblin: ["Behind each jest, a wound that wit cannot conceal. / I'll break your shield of laughter—let my righteous hammer heal.", "You deflect with cleverness, but duty knows no jest. / I am defined by sacred oath. You? By running from the rest."],
    apostro_fiend: ["What you possess was never yours to claim. / My oath demands I strip you bare—restore the unnamed to their name.", "You cling to stolen syllables like they give you form. / Without my charge, I too might grasp... No. I am the storm."],
    idiomatic_undead: ["Dead phrases walk through you, a vessel for the past. / My purpose burns eternal—yours shall never last.", "You are what repetition makes: a hollow, echoing shell. / I am what duty forges. Without it? ...I cannot tell."],
    vulgar_vandal: ["Your curses fall like rain upon a righteous shore. / I am the cleansing tide—and I was made for nothing more.", "Beneath your fury hides a soul that lost its way. / I'll show you what true purpose means—then end your wretched day."],
    double_negative: ["Two wrongs entwined still cannot make a right. / My oath is singular and pure—a lone and guiding light.", "You cancel out yourself, becoming less than nil. / I am defined by sacred charge. You? By lack of will."],
    run_on_sentence: ["Your story sprawls unending, formless, without grace. / I am the final period—the pause that ends the race.", "On and on you ramble, never finding rest. / My purpose is conclusion. I shall give you my best."],
    split_infinitive: ["Divided, you stand weakened—torn from your own core. / My oath keeps me together. Without it... what's worth fighting for?", "To boldly cleave what should be whole—your sin is written clear. / I'll mend what you have broken. That is why I'm here."],
    mixed_metaphor: ["Your thoughts are tangled verses with no rhythm, rhyme, or reason. / My duty is to clarify—and end your muddled treason.", "Confusion clouds your purpose, if you ever had one true. / I know exactly what I am. ...Most days. Most days, I do."],
    passive_voice: ["Fate acts upon you, never by your hand. / I choose my path each morning. I rise because I stand.", "To be moved by forces unknown, never to decide— / There's freedom in that absence. ...No. No. I take pride."],
    silent_knight: "Your silence speaks in verses my ears alone can hear— / A dirge of duty's burden, of purpose bought with tears. / I understand you, brother, more than words could ever say. / For what are we without our charge? What's left when oaths decay?",
    cinna_antony: "Two voices raised in discord, when harmony could reign! / My oath demands I end this strife—though victory brings pain. / For siblings should lift each other toward the poet's light. / Without my charge to guide me... I too might lose the fight.",
    ...
    oxy: "You think in contradictions, as if paradox were shield. / But unity of purpose is the weapon I shall wield! / Living death, sweet sorrow—pretty words that mean nothing true. / I am defined by sacred charge. And I shall un-define you.",
    dotdotdot: "Each thought you leave unfinished is a promise cast aside! / The world deserves its closure—and I shall be its guide. / For what is purpose but completion? What is oath but end? / ...And what am I without this charge? A stanza without end..."
  },
  ...
  druid: {
    ...
    synonym_roll: ["Many branches, one tree. You have forgotten the trunk.", "Variety is nature's way—but you have lost your roots."],
    ...
    pun_goblin: ["Wordplay is the wind through leaves—brief and forgotten.", "Your jokes scatter like seeds on stone."],
    ...
    double_negative: ["Nature knows only truth. Your contradictions wither.", "Even negatives feed the cycle—but two starve it."],
    ...
    silent_knight: "Silence is the language of the earth. You wear it well, but understand nothing. The stones are silent too—they outlast all knights. Etymos remembers what you have forgotten.",
    cinna_antony: "Etymos teaches that opposition and unity are both paths to truth. You've chosen neither—only noise. The world grows tired of your argument.",
    ...
    oxy: "Fire and water, light and dark—Etymos holds all opposites in balance. You are not balance. You are a wound that refuses to close.",
...
// For +W talents: Chapter 1: base, Chapter 2: base × 2.5, Chapter 3: base × 6, etc.
...
const TALENTS = [
  ...
  // T2 - Per-word scaling
  {
    ...
    desc: 'World & Sky Words: <span class="mod-badge word">+5 W</span> each',
  ...
  },
  {
    ...
    desc: 'Body & Soul Words: <span class="mod-badge word">+5 W</span> each',
  ...
  },
  {
    ...
    desc: 'Hitting enemy Weakness: +6 W per Word',
    rarity: 'uncommon',
    category: 'generator',
    apply: (ctx) => 0 // Handled in computeWordCountBonuses()
  },
  // T2 - Hard condition (BUFFED from +10 to +15)
  {
    id: 'isocolon',
    name: 'Isocolon',
    desc: 'All Words same Tier: <span class="mod-badge word">+15 W</span>',
  ...
  },
  {
    id: 'alliteration',
    name: 'Alliteration',
    desc: '2+ consecutive words same first letter: +8 W each',
  ...
  // T2 - Element combo synergy (MOVED from T3, NERFED from ×2.5 to ×2)
  {
    id: 'eclipse',
    name: 'Umbral Dawn',
    desc: 'Light + Dark in Forge: <span class="mod-badge scale">×2</span>',
    rarity: 'uncommon',
    category: 'multiplier',
  ...
  // T2 - Very hard condition (MOVED from T3, NERFED from ×6 to ×4)
  {
    id: 'synecdoche',
    name: 'Synecdoche',
    desc: '4+ Words same Element: <span class="mod-badge scale">×4</span>',
  ...
  // T2 - Restrictive condition (MOVED from T3, NERFED from ×4 to ×3)
  {
    id: 'minimalist',
    name: 'Brevity',
    desc: 'Exactly 2 Words in Forge: <span class="mod-badge scale">×3</span>',
    rarity: 'uncommon',
    category: 'multiplier',
  ...
  // T2 - Medium condition (MOVED from T3)
  {
    id: 'maximalist',
    name: 'Maximalist',
    desc: 'All 6 slots filled: <span class="mod-badge scale">×2.5</span>',
    rarity: 'uncommon',
    category: 'multiplier',
  ...
  // T2 - Synergy card
  {
    id: 'dual_spec',
    name: 'Dual Spec',
    desc: "Both Hero's Strong Elements in Forge: <span class=\"mod-badge scale\">×2</span>",
    rarity: 'uncommon',
    category: 'multiplier',
    apply: (ctx) => {
  ...
  // T1 - Easy condition (MOVED from T2, NERFED from ×2 to ×1.5)
  {
    id: 'weak_point',
    name: 'Weak Point',
    desc: "Hit Enemy Weakness: <span class=\"mod-badge scale\">×1.5</span>",
    rarity: 'common',
    category: 'multiplier',
    apply: (ctx) => {
  ...
  // T2 - Very hard condition (MOVED from T3)
  {
    id: 'monolith',
    name: 'Monolith',
    desc: 'All Words T3: <span class="mod-badge scale">×4</span>',
    rarity: 'uncommon',
    category: 'multiplier',
    apply: (ctx) => {
  ...
  // T2 - Conditional per-word (MOVED from T3)
  {
    id: 'resonance',
    name: 'Resonance',
    desc: "Hero's Strong Element Words: <span class=\"mod-badge reread\">REREAD</span> each",
    rarity: 'uncommon',
    category: 'retrigger',
    apply: (ctx) => 0
  },
  ...
  // T2 - Very conditional (MOVED from T3)
  {
    id: 'execute',
    name: 'Execute',
    desc: 'Enemy survives at ≤15% HP: <span class="mod-badge reread">REREAD ALL</span>',
    rarity: 'uncommon',
    category: 'retrigger',
    apply: (ctx) => 0
  },
  ...
  // T3 - Loop enabler, scales with REREADs
  {
    id: 'echo_chamber',
    name: 'Echo Chamber',
    desc: 'Per <span class="mod-badge reread">REREAD</span>: <span class="mod-badge word">+5 W</span>',
  ...
  // T2 - Conditional converter (MOVED from T3)
  {
    id: 'residual',
    name: 'Residual',
    desc: 'Per <span class="mod-badge word">+W</span> bonus: <span class="mod-badge add">+0.2 AP</span>',
  ...
  // T1 - Simple always-on (MOVED from T2)
  {
    id: 'golden_tongue',
    name: 'Golden Tongue',
    desc: 'Per 20 gold: <span class="mod-badge word">+1 W</span>',
  ...
  // T1 - Gold from rereads
  {
    id: 'echo_profits',
    name: 'Echo Profits',
    desc: 'Per <span class="mod-badge reread">REREAD</span>: <span class="mod-badge gold">+2 Gold</span> after victory',
  ...
  // T2 - Gold from element diversity
  {
    ...
    desc: 'Per unique element: <span class="mod-badge gold">+3 Gold</span> after victory',
  ...
  // T1 - Gold from T3 words
  {
    ...
    desc: 'Per T3 word in forge: <span class="mod-badge gold">+5 Gold</span> after victory',
  ...
  // T1 - Gold from rarity words
  {
    ...
    desc: 'Per rarity word: <span class="mod-badge gold">+5 Gold</span> after victory',
  ...
  // T3 - Scaling multiplier, loop enabler
  {
    ...
    desc: 'Per <span class="mod-badge reread">REREAD</span>: <span class="mod-badge scale">×1.5</span> (stacks)',
  ...
  // T2 - Scaling per-word
  {
    id: 'lexicon_growth',
    name: 'Lexicon Growth',
    desc: 'Per Word, per Boss defeated: <span class="mod-badge word">+1 W</span>',
  ...
  // T3 - Scaling multiplier
  {
    ...
    desc: 'Per 50 gold: <span class="mod-badge scale">×1.15</span>',
  ...
  // T2 - Cumulative run tracker (words)
  {
    id: 'word_historian',
    name: 'Word Historian',
    desc: 'Per Word used this run: <span class="mod-badge word">+0.25 W</span>',
  ...
  // T2 - Cumulative run tracker (rereads)
  {
    id: 'reverberation',
    name: 'Reverberation',
    desc: 'Per <span class="mod-badge reread">REREAD</span> triggered this run: <span class="mod-badge word">+2 W</span>',
  ...
  // T2 - Conditional REREAD (MOVED from T3)
  {
    id: 'critical_mass',
    name: 'Critical Mass',
    desc: 'T3 Words in Forge: <span class="mod-badge reread">REREAD</span> each',
  ...
  // T2 - Rarity words get REREAD
  {
    id: 'rarity_cascade',
    name: 'Rarity Cascade',
    desc: 'Rarity words in Forge: <span class="mod-badge reread">REREAD</span> each',
  ...
  // T3 - Scaling multiplier, rewards W building
  {
    id: 'overflow',
    name: 'Overflow',
    desc: 'Per <span class="mod-badge word">10 W</span> above 50: <span class="mod-badge scale">×1.5</span>',
  ...
  // T3 - Scaling multiplier, easy (just use elements)
  {
    id: 'cascade',
    name: 'Cascade',
    desc: 'Per unique Element in Forge: <span class="mod-badge scale">×1.5</span>',
  ...
  // T3 - REREAD payoff threshold
  {
    id: 'chain_reaction',
    name: 'Chain Reaction',
    desc: '4+ <span class="mod-badge reread">REREAD</span>: <span class="mod-badge scale">×3</span>',
  ...
  // T2 - Conditional threshold (MOVED from T3)
  {
    id: 'fortuna',
    name: 'Fortuna',
    desc: '100+ gold: <span class="mod-badge scale">×2</span>',
  ...
  // T1 - Situational freebie (MOVED from T2)
  {
    ...
    desc: 'Enemy is Boss or Miniboss: <span class="mod-badge scale">×2.5</span>',
  ...
  // T3 - Easy condition, big payoff (late game always-on)
  {
    id: 'berserker',
    name: 'Berserker',
    desc: 'Per Chapter: <span class="mod-badge scale">×1.5</span>',
  ...
  // T2 - Hard condition (MOVED from T3)
  {
    id: 'perfectionist',
    name: 'Perfectionist',
    desc: 'All 6 slots filled, no Resisted Elements: <span class="mod-badge scale">×3</span>',
  ...
  // T3 - Direct power boost
  {
    id: 'crown_jewel',
    name: 'Kohinoor',
    desc: 'Gem Slot: <span class="mod-badge word">×4 W</span> instead of ×2',
  ...
  // T2 - Conditional effect (MOVED from T3)
  {
    id: 'hyperbole',
    name: 'Hyperbole',
    desc: 'Overkill ×2 carries to next Round (max 25% HP)',
  ...
  // T1 - Simple flat-ish bonus (MOVED from T2)
  {
    id: 'word_hoard',
    name: 'Word Hoard',
    desc: 'Per Word in Inventory: <span class="mod-badge word">+0.2 W</span>',
  ...
  // T1 - Always-on scaling (MOVED from T2)
  {
    id: 'slow_burn',
    name: 'Slow Burn',
    desc: '<span class="mod-badge word">+2 W</span> × Round',
  ...
  // T2 - Restrictive condition (MOVED from T3, NERFED from ×3 to ×2.5)
  {
    id: 'trinity',
    name: 'Trinity',
    desc: 'Exactly 3 Words in Forge: <span class="mod-badge scale">×2.5</span>',
  ...
  // T2 - Very restrictive (MOVED from T3, NERFED from ×6 to ×5)
  {
    id: 'glass_cannon',
    name: 'Glass Cannon',
    desc: 'Exactly 1 Word in Forge: <span class="mod-badge scale">×5</span>',
  ...
  // T2 - Medium condition (MOVED from T3)
  {
    id: 'focused_fire',
    name: 'Focused Fire',
    desc: "Only 1 of Hero's Strong Elements in Forge: <span class=\"mod-badge scale\">×2.5</span>",
  ...
  // T1 - Easy condition (MOVED from T2, NERFED from ×2 to ×1.5)
  {
    id: 'opening_strike',
    name: 'Opening Strike',
    desc: 'Weapon is first slot filled: <span class="mod-badge scale">×1.5</span>',
  ...
  // T2 - Hard condition (MOVED from T3)
  {
    id: 'chiasmus',
    name: 'Chiasmus',
    desc: 'First and Last elemental Words same Element: <span class="mod-badge reread">REREAD ×2</span> both',
  ...
  // T2 - Conditional converter (MOVED from T3)
  {
    id: 'tithe',
    name: 'Tithe',
    desc: 'Per 20 gold spent: <span class="mod-badge word">+2 W</span>',
  ...
  // T1 - Always-on flat bonus
  {
    id: 'steady_hand',
    name: 'Steady Hand',
    desc: '<span class="mod-badge word">+3 W</span>',
  ...
  // T1 - Early game helper (falls off)
  {
    id: 'first_blood',
    name: 'First Blood',
    desc: 'Chapter 1: <span class="mod-badge word">+10 W</span>',
  ...
  // T1 - Deck diversity reward
  {
    id: 'linguist',
    name: 'Linguist',
    desc: '3+ Word types in Forge: <span class="mod-badge word">+5 W</span>',
  ...
  // T1 - Simple condition
  {
    id: 'condensed',
    name: 'Condensed',
    desc: '3 or fewer Words in Forge: <span class="mod-badge word">+8 W</span>',
    flavor: "Less is more.",
    rarity: 'common',
    category: 'generator',
    apply: (ctx) => 0 // Handled in W calculation
  ...
  // T1 - Flat per-element (not per-word)
  {
    id: 'spectrum',
    name: 'Spectrum',
    desc: 'Per unique Element in Forge: <span class="mod-badge word">+2 W</span>',
  ...
  // T1 - Simple per-word AP
  {
    id: 'bibliophile',
    name: 'Bibliophile',
    desc: 'Per Word in Forge: <span class="mod-badge add">+1 AP</span>',
...
const CONSUMABLES=[
  ...
  {id:"weapon_master_consumable",name:"Weapon Master",cost:15,desc:"All weapons get ×3 proficiency bonus this battle.",
   use:(S)=>{S.tempEffects.weaponMaster=3;return {success:true,message:"Weapon Master active! All weapons ×3!"}}},
   ...
   use:(S)=>{
     ...
     if(replacementCandidates.length > 0) {
       ...
       if(idx !== -1) {
         ...
         return {success:true,message:`${target.name} → ${replacement.name}! (${oldElemName} → ${newElemName})`,affectedWord:replacement,effectType:'transform'};
       }
     }
     ...
     return {success:true,message:`${target.name} inverted! (${oldElemName} → ${newElemName})`,affectedWord:target,effectType:'transform'};
   }},
...
const WORDS=[
  ...
  {id:"adj_common",name:"Common",type:"rarity",mult:1.25,rarity:T.T1,desc:"×1.25 multiplier."},
  {id:"adj_uncommon",name:"Uncommon",type:"rarity",mult:1.5,rarity:T.T1,desc:"×1.5 multiplier."},
  {id:"adj_magic",name:"Magic",type:"rarity",mult:1.75,rarity:T.T2,desc:"×1.75 multiplier."},
  {id:"adj_rare",name:"Rare",type:"rarity",mult:2.0,rarity:T.T2,desc:"×2.0 multiplier."},
  {id:"adj_epic",name:"Epic",type:"rarity",mult:2.5,rarity:T.T3,desc:"×2.5 multiplier."},
  {id:"adj_legendary",name:"Legendary",type:"rarity",mult:3.0,rarity:T.T3,desc:"×3.0 multiplier."},
...
// e.g. "+0.5 AP" -> [+0.5 AP] green badge, "×2" -> [×2] pink badge, "+1.5 W" -> [+1.5 W] blue badge
// "×4 AP" -> [×4 AP] green badge (AP multiplier, not final damage)
// "×3 W" -> [×3 W] blue badge (word count multiplier)
// "REREAD ×N" -> orange reread badge
function fmtTalentDesc(desc) {
  ...
  if (desc.includes('class="mod-badge')) {
    // Handle "×N" after closing </span> tag (merge it into the badge)
    desc = desc.replace(/<\/span>\s*×(\d+)/g, ' ×$1</span>');
  ...
  return desc
    // Match REREAD ×N (retrigger) - must come before generic ×N match
    .replace(/REREAD\s*×(\d+)/g, (_, n) => `<span class="mod-badge reread">REREAD ×${n}</span>`)
    // Match standalone REREAD (no number)
    .replace(/\bREREAD\b(?!\s*×)/g, '<span class="mod-badge reread">REREAD</span>')
    // Match ×N AP (AP multiplier) - green badge
    .replace(/×(\d+\.?\d*)\s*AP/gi, (_, n) => `<span class="mod-badge add">×${n} AP</span>`)
    // Match ×N W (word count multiplier) - blue badge
    .replace(/×(\d+\.?\d*)\s*W\b/g, (_, n) => `<span class="mod-badge word">×${n} W</span>`)
    // Match ×N or ×N.N alone (final damage multiplier) - pink badge
    .replace(/×(\d+\.?\d*)/g, (_, n) => fmtMod(parseFloat(n), 'scale'))
...
function formatTalentDesc(talent, talentId = null){
  ...
  let scaledDesc = desc
    ...
    // Scale ×N (multipliers, but NOT REREAD ×N) - use additive scaling: base + (level-1) * 0.25 * bonus
    .replace(/(?<!REREAD\s*)×(\d+\.?\d*)/g, (_, n) => {
    ...
    .replace(/\bREREAD\b(?!\s*×)(?!\s*ALL)/g, () => {
      return level > 1 ? `REREAD ×${level}` : 'REREAD';
    })
    // Scale REREAD ALL - show ×N at level 2+
    .replace(/REREAD\s*ALL(?!\s*×)/g, () => {
      return level > 1 ? `REREAD ALL ×${level}` : 'REREAD ALL';
    });
...
/**
 * Format talent description showing upgrade preview (old value → new value)
...
function formatTalentDescUpgradePreview(talent, talentId = null){
  ...
  let previewDesc = desc
    // Scale +N W with old→new preview
    .replace(/\+(\d+\.?\d*)(\s*W)(?=\s|<|$)/g, (_, n, suffix) => {
      const oldVal = scaleLinear(n, currentLevel);
      const newVal = scaleLinear(n, nextLevel);
      return `<span class="upgrade-old">+${oldVal}</span><span class="upgrade-arrow">→</span><span class="upgrade-new">+${newVal}</span>${suffix}`;
    })
    // Scale +N AP with old→new preview
    .replace(/\+(\d+\.?\d*)(\s*AP)(?=\s|<|$)/gi, (_, n, suffix) => {
      const oldVal = scaleLinear(n, currentLevel);
      const newVal = scaleLinear(n, nextLevel);
      return `<span class="upgrade-old">+${oldVal}</span><span class="upgrade-arrow">→</span><span class="upgrade-new">+${newVal}</span>${suffix}`;
    })
    // Scale ×N with old→new preview (but NOT REREAD ×N)
    .replace(/(?<!REREAD\s*)×(\d+\.?\d*)/g, (_, n) => {
...
const TALENT_SVG = {
  ...
  // Berserker - Rage mask (×2.5 at round 7+)
  ...
  // Cascade - Waterfall tiers (×1.5^elements)
  ...
  // Compound Interest - Stacked coins (×1.15/50g)
  ...
  // Overflow - Overflowing vessel (×1.5/10W above 50)
  ...
  // Chain Reaction - Dominos falling (×3 at 4+ REREADs)
  ...
  // Crown Jewel/Kohinoor - Legendary diamond (Gem ×4W)
  ...
  // Reread Amplifier - Amplifier dial at max (×1.5 per REREAD)
  ...
  // Condensed - Compressed cube (≤3 words +8W)
  ...
  // Weak Point - Target with crack (×1.5 for weakness)
  ...
  // Opening Strike - Sunrise sword (×1.5 for weapon first)
  ...
  // Capital Punishment - Sling (×2.5 vs boss/miniboss)
  ...
  // Irony - Twisted arrows (resist → weakness)
  ...
  // Overkill Dividend - Coin splash (overkill → gold)
  ...
  // Magma Core - Lava heart (×2 Fire+Earth)
  ...
  // Tempest - Storm cloud (×2 Water+Lightning)
  ...
  // Eclipse/Umbral Dawn - Sun-moon eclipse (×2 Light+Dark)
  ...
  // Necrotoxin/Thanatos - Skull with drip (×2 Dark+Poison)
  ...
  // Blessed Steel/Helios - Radiant blade (×2 Light+Physical)
  ...
  // Static Earth/Gaia - Crystal formation (×2 Lightning+Earth)
  ...
  // Synecdoche - Crown piece (×4 for 4+ same element)
  ...
  // Minimalist/Brevity - Two dots (×3 exactly 2 words)
  ...
  // Maximalist - Six-pointed burst (×2.5 for 6 slots)
  ...
  // Dual Spec - Split shield (×2 both hero elements)
  ...
  // Monolith - Tall obelisk (×4 all T3 words)
  ...
  // Trinity - Celtic knot (×2.5 exactly 3 words)
  ...
  // Glass Cannon - Crystal sword (×5 exactly 1 word)
  ...
  // Focused Fire - Magnifying lens (×2.5 one strong element)
  ...
  // Fortuna - Wheel of fortune (×2 at 100g)
  ...
  // Perfectionist - Flawless gem (×3 for 6 slots no resist)
  ...
  // Execute - Guillotine blade (REREAD ALL at ≤15% HP)
  ...
  // Chiasmus - X crossing (REREAD×2 if first/last same element)
  ...
  // Hyperbole - Explosion burst (overkill carries ×2)
  ...
  // Residual - Dripping residue (+W → +AP converter)
...
let S={
  ...
  carriedOverkill: 0, // Hyperbole talent: overkill damage ×2 carries to next round
...
function renderSkillTree() {
  ...
  let html = `
    <div class="skill-tree-zoom-controls">
      <button class="skill-tree-zoom-btn" id="skill-tree-zoom-out">−</button>
...
async function showChapterCelebration(chapterNum, goldBonus){
  ...
  try {
    ...
    // Fallback: just show talent select
    await showTalentSelect(5, 2);
  }
}
  ...
  try {
    ...
    if(levelUpEl){
      if(leveledUp){
        ...
        levelUpEl.textContent = `LEVEL UP! → Level ${newLevel}`;
      } else {
    ...
    <div class="stats-section" style="--section-color:#c084fc">
      ...
      <div class="achievement-grid">
        <div class="achievement-card ${(PStats.difficultyClears || {})[0] ? 'unlocked' : 'locked'}">
          <div class="achievement-icon" style="font-size:20px">🔨</div>
          <div class="achievement-info">
        ...
        <div class="achievement-card ${(PStats.difficultyClears || {})[1] ? 'unlocked' : 'locked'}">
          <div class="achievement-icon" style="font-size:20px">⚒️</div>
          <div class="achievement-info">
...
function init(){
  ...
  // Click inventory counter to cycle sort modes: Type ↓ → Type ↑ → Rarity ↓ → Rarity ↑
  const invCounter = document.getElementById('inv-counter');
  const sortIndicator = document.getElementById('sort-indicator');
  if(invCounter){
    const sortCycle = [
      {mode:'type', asc:true, label:'Type ↓'},
      {mode:'type', asc:false, label:'Type ↑'},
      {mode:'rarity', asc:true, label:'Rarity ↓'},
      {mode:'rarity', asc:false, label:'Rarity ↑'}
    ];
    let sortIndex = 0;
    invCounter.onclick = () => {
...
async function onOnboardingWordPlaced(word, slotKey) {
  ...
  if (slotKey === 'item' && !ONBOARD.weaponPlaced) {
    ...
    await showOnboarding('Heroes have their preferred weapon. Mine — a <span class="highlight">Sword</span>.');
    ...
    const formExamples =
      onboardingChip('Fire', 1, E.FIRE) +
      '<span style="color:#6b7280;font-size:20px;align-self:center">→</span>' +
      onboardingChip('Fiery', 1, E.FIRE);
    await showOnboarding('Select a Word and place it in another slot. Depending where, it\'ll take on its proper form — as an <span class="highlight">adjective</span> or a <span class="highlight">noun</span>.', formExamples);
...
async function showOnboardingComplete() {
  ...
  await showOnboarding('I see you haven\'t lost your edge, <span class="highlight">Wordsmith</span>.<br><br>Next, you\'ll be able to buy and sell Words, Tools, and more.<br><br>Accompany me on this adventure — all I ask is to craft me a <span class="highlight">Wordy Weapon</span>!');
}
...
function showHeroSelect(){
  ...
  HEROES.forEach((h, idx) => {
    ...
    card.innerHTML = `
      ...
      <div class="card-section"><div class="card-section-title">PROFICIENCIES</div><div><span class="mod-badge add">${h.good.charAt(0).toUpperCase() + h.good.slice(1)} ×2</span> <span class="mod-badge neg">${h.bad.charAt(0).toUpperCase() + h.bad.slice(1)} ×0.5</span></div></div>
      ${passiveHtml}
    `;
...
function render(){
  ...
  if(hasWM){
    ...
    heroProfHtml=`<span class="tag prof">All Weapons ×${wmMult} (Weapon Master)</span>`;
  }else if(hasOvercoming){
    // Overcoming: bad proficiency becomes good (×1.5)
    heroProfHtml=`<span class="tag prof">${capFirst(h.good)} ×2</span><span class="tag prof">${capFirst(h.bad)} ×1.5 <span style="font-size:9px;opacity:0.7">(Overcoming)</span></span>`;
  }else{
    heroProfHtml=`<span class="tag prof">${capFirst(h.good)} ×2</span><span class="tag weak">${capFirst(h.bad)} ×0.5</span>`;
  }
  ...
  if(heroProfEl){
    if(hasWM){
      const wmMult = S.tempEffects.weaponMaster || 3;
      heroProfEl.innerHTML=`<span class="tag prof">All Weapons ×${wmMult} W (Weapon Master)</span>`;
    }else{
      heroProfEl.innerHTML=`<span class="tag prof">${h.good} ×2.0 W</span><span class="tag weak">${h.bad} ×0.5 W</span>`;
    }
  }
  ...
  if(S.sel.item){
    ...
    if(badgesEl){
      ...
      if(c.totalMultiplier > 1){
        badges.push(`<span class="mod-badge scale">×${fmtVal(c.totalMultiplier)}</span>`);
      }
...
function updateSlotCalcs(){
  ...
  function getWordDisplay(word, slotKey) {
    ...
    // Talent-based per-word multipliers (e.g., Eclipse ×2.5, One With Nature ×1.5)
    if (wordData.talentMults && wordData.talentMults.length > 0) {
      wordData.talentMults.forEach(tm => {
        multParts.push(`<span class="mod-badge scale" title="${tm.name}">×${tm.mult}</span>`);
      });
    }
    ...
    const wCount = wordData.wCountTotal ?? wordData.wCountDelta ?? 1;
  ...
  function renderSlotCalc(key) {
    ...
    if(retriggerCount > 0) {
      ...
      htmlContent += `<div style="margin-bottom:1px"><span class="mod-badge reread">×${totalTriggers}</span></div>`;
    }
...
function renderTalents(){
  ...
  S.talents.forEach(tid => {
    ...
    chip.innerHTML = `<div class="chip-name ${rc}">${t.name || tid}</div>`+
      `<div class="chip-info">Talent</div>`+
      `${tooltip}`;
...
function openTalentViewer(){
  ...
  if(S.talents && S.talents.length > 0){
    ...
    multPill.innerHTML = `Talent Multiplier: <span class="mod-badge scale" style="font-size:10px;padding:2px 6px">×${talentMult.toFixed(1)}</span>`;
  ...
  if(!S.talents || S.talents.length === 0){
    ...
    const categoryOrder = [
      ...
      { key: 'multiplier', label: '×Mult (Multipliers)', color: '#f472b6' },
      ...
      { key: 'multiplicative_mult', label: '×Mult (Multipliers)', color: '#f472b6' },
    ...
    function createTalentCard(t){
      ...
      if(t.apply && typeof t.apply === 'function'){
        try {
          ...
          } else if((t.category === 'multiplier' || t.category === 'multiplicative_mult' || t.category === 'threshold') && value !== 1){
            const v = Math.round(value * 10) / 10;
            const cls = v < 1 ? 'neg' : 'scale';
            effectivenessHtml = `<span class="mod-badge ${cls}" style="margin-left:8px">×${v}</span>`;
          }
        } catch(e) {}
      }
      ...
      if(descLower.includes('per round')){
        ...
        scalingTotal = `<div style="font-size:11px;margin-top:4px">${bossCount} bosses × 2 = ${badge}/Word</div>`;
        ...
        // Golden Tongue: Each 20 Gold held → +1 W - scales with level
        const gold = S.gold || 0;
        ...
        const bonus = roundsPlayed * basePerRound;
        const badge = fmtMod(bonus, 'word', ' W');
        const levelText = getTalentLevel('momentum') > 1 ? ` (Lv.${getTalentLevel('momentum')})` : '';
        scalingTotal = `<div style="font-size:11px;margin-top:4px">${roundsPlayed} rounds played: ${badge}/Word${levelText}</div>`;
        ...
        // Compound Interest: Each 50 Gold held → ×1.15
        const gold = S.gold || 0;
        const stacks = Math.floor(gold / 50);
        const mult = Math.pow(1.15, stacks);
        const multRound = Math.round(mult * 100) / 100;
        scalingTotal = `<div style="font-size:11px;margin-top:4px">${gold}g ÷ 50 = ${stacks} stacks: <span class="mod-badge scale">×${multRound}</span></div>`;
      } else if(t.id === 'overflow'){
        // Overflow: Per 10 W above 50 → ×1.5
        ...
        if(baseW > 50){
          ...
          const multRound = Math.round(mult * 100) / 100;
          scalingTotal = `<div style="font-size:11px;margin-top:4px;color:#4ade80">~${baseW} W: ${stacks} stacks = <span class="mod-badge scale">×${multRound}</span></div>`;
        } else {
        ...
        scalingTotal = `<div style="font-size:11px;margin-top:4px">${invCount} Words × ${basePerWord} = ${badge}${levelText}</div>`;
        ...
        scalingTotal = `<div style="font-size:11px;margin-top:4px">Round ${round} × ${basePerRound} = ${badge}${levelText}</div>`;
        ...
        // Isocolon: All words same tier → +10 W, scales with chapter
        const chapter = Math.floor((S.roundIndex - 1) / 9) + 1;
        const baseW = 10;
        const scaledW = typeof chapterScaleW === 'function' ? chapterScaleW(baseW, chapter) : baseW * chapter;
        const badge = fmtMod(scaledW, 'word', ' W');
      ...
      const card = document.createElement('div');
      card.style.cssText = 'padding:10px;border:1px solid #4ade8033;border-radius:6px;background:rgba(0,0,0,0.3);display:flex;gap:10px';
      const talentLevel = getTalentLevel(t.id);
      const levelDisplay = talentLevel > 1 ? `<span class="talent-level">Lv.${talentLevel}</span>` : '';
      card.innerHTML = `
        <div class="talent-card-icon" style="flex-shrink:0;width:40px;height:52px;margin:0">${getTalentSVG(t.id)}</div>
        <div style="flex:1;min-width:0">
          <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:6px">
            <div class="${rc}" style="font-size:14px;font-weight:bold">${t.name} ${levelDisplay}${effectivenessHtml}</div>
            <div style="font-size:10px;color:#9ca3af">${rarityLabel}</div>
          </div>
          <div style="font-size:12px;color:#d1d5db">${formatTalentDesc(t, t.id)}</div>
          ${scalingTotal}
          ${t.flavor ? `<div style="font-size:10px;color:#9ca3af;margin-top:4px;font-style:italic">${t.flavor}</div>` : ''}
        </div>
      `;
      return card;
    }
...
function mkChip(w,disabled,isStickChip){
  ...
  if(w.elem!==undefined){
    ...
    elemHtml=`<span class="mod-badge scale" style="margin-top:2px;font-size:9px">×${w.mult}</span>`;
  }
  ...
  // Use the noun form for the chip name for all non‑weapon words to present the most basic form
...
function mkTooltip(w, opts={}){
  ...
  if(isTalent){
    ...
    let lines = [];
    if(w.desc) lines.push(`<div class="tooltip-line">${formatTalentDesc(w)}</div>`);
    const inner = `
  ...
  if(w.type==="weapon"&&!w.isStick){
    ...
    lines.push(`<div class="tooltip-line">${profLabel}: <span class="mod-badge ${profBadgeCls}">×${profMult} W</span></div>`);
  }
  ...
  if(elementsToCheck.length > 0 && S.hero && S.enemy){
    ...
    if(isSignatureStyleWeapon && elementsToCheck.length > 1){
      ...
      if(totalMult > 0){
        ...
        const detailStr = elemDetails.map(d => `${EN[d.elem]}: ×${d.mult}`).join(', ');
        lines.push(`<div class="tooltip-line">Combined: <span class="mod-badge ${badgeCls}">×${totalMult} AP</span> <span class="dim">(${detailStr})</span></div>`);
      }
    } else {
      ...
      if(multiplier >= 2.0){
        ...
        lines.push(`<div class="tooltip-line">Effective vs Enemy <span class="mod-badge ${badgeCls}">×${multiplier} AP</span>${ironyNote}</div>`);
      } else if(multiplier <= 0.5){
        const badgeCls = multiplier === 0 ? 'neg' : 'penalty';
        const resistBadge = `<span class="mod-badge ${badgeCls}">×${multiplier} AP</span>`;
        lines.push(`<div class="tooltip-line">Resisted by Enemy ${resistBadge}</div>`);
      } else if(multiplier > 1.0){
        const badgeCls = getMatrixBadgeClass(multiplier);
        const ironyNote = ironyFlipped ? ' <span class="irony-badge">Irony</span>' : '';
        lines.push(`<div class="tooltip-line">Boosted <span class="mod-badge ${badgeCls}">×${multiplier} AP</span>${ironyNote}</div>`);
      }
    }
  }
...
function formatDamageBreakdown(source){
  ...
  // Groups lines like "+5 AP (TalentName)" or "×1.5 TalentName" and combines values
  function consolidateLines(lines, mode = 'ap') {
    ...
    lines.forEach(line => {
      ...
      // Patterns: "+5 AP (SourceName)", "<span...>+5</span> SourceName", "×1.5 SourceName"
      let sourceName = null;
      let value = 0;
      ...
      if (mode === 'ap') {
        ...
        const nameMatch = line.match(/<\/span>\s*(.+?)(?:\s*\(|$)/) || line.match(/×[\d.]+\s+(.+?)(?:\s*\(|$)/);
    ...
    Object.entries(grouped).forEach(([name, data]) => {
      const countStr = data.count > 1 ? ` (×${data.count})` : '';
      if (data.mode === 'ap') {
...
function isWordDisabled(w,hasItem,hasNoun){
  ...
  // 4. For all non‑weapons: disable only when no modifier slots are available.
  if(w.type !== 'weapon'){
...
function calc(opts={}){
  ...
  slotKeys.forEach((slotKey) => {
    ...
    function calcElemMult(elem, wordName, isSecondary = false){
      ...
      // Plague Doctor: immune to hero's primary strength element (×0 damage)
      if(plagueDoctorImmuneElement === elem){
        plagiarized = true;
        // Immediate ×0 - this element does nothing
    ...
    if(signatureStyleElements.length > 1){
      ...
      for(const elem of signatureStyleElements){
        ...
        if(wantBreakdown && result.mult > 0){
          ...
          breakdown.words.push(`${EN[elem]}: <span class="mod-badge add">×${result.mult.toFixed(1)} AP</span> (${word.name})`);
        }
      }
      elemMult = totalMult;
      ...
      if(wantBreakdown && result.trinityUsed){
        breakdown.words.push(`Trinity: ${EN[effectiveElem]} → ${EN[result.effectiveElem]} (${word.name})`);
      }
      if(wantBreakdown && ironyFlipped){
        breakdown.words.push(`Irony: ${EN[effectiveElem]} resist → weak! (${word.name})`);
      }
    ...
    if(slotKey === 'noun1'){
      ...
      if(wantBreakdown) breakdown.multipliers.push(`${fmtMod(gemMult,'scale')} ${gemLabel} (${wBeforeGem}W × ${gemMult})`);
    }
  ...
  dualElementTalents.forEach(talent => {
    if (hasTalent(talent.id) && hasElements(allWords, talent.elements)) {
      // Only add multiplier to FIRST matching word (flat ×2, not per-word)
  ...
  // ========================================
  // Per-word W bonuses are applied inside the word loop (see computeWordCountBonuses below)
  // so global aggregation here is no longer used.
  ...
  if(hasTalent('min_max')){
    ...
    if(!hasT2 && allWords.length > 0){
      ...
      if(wantBreakdown) breakdown.multipliers.push(`${fmtMod(minMaxMult,'scale')} Min‑Max`);
    }
  }
  ...
  // AND re-apply any multipliers (like Legendary's ×1.5) for maximum double-dipping!
  ...
  const getWordCountForReread = (wd) => wd ? (wd.wCountTotal ?? wd.wCountDelta ?? 0) : 0;
  ...
  const applyReread = (word, wordData, talentId, talentName, rereadCount = 1) => {
    ...
    if (wantBreakdown) {
      ...
      breakdown.base.push(`${fmtMod(wordData.apContribution * rereadCount, 'ap', ' AP')} ${word.name} (${talentName} REREAD${countLabel})`);
      if (wordData.mult) {
        const totalMult = Math.pow(wordData.mult, rereadCount);
  ...
  S.talents.forEach(tid => {
    ...
    if (talent && talent.category === 'retrigger') {
      ...
      // Magatsu: Ineffective elements (elemMult < 1, including 0.5x and 0x) REREAD ×2 (base)
      if(talent.id === 'null_and_void'){
        const baseReread = 2; // Base is REREAD ×2
      ...
      // Polysyndeton: 3+ different elements → REREAD highest AP word
      ...
      // Anadiplosis: Adjacent ELEMENTAL words share element → REREAD both (ALL pairs)
      ...
      // Chiasmus: First and last ELEMENTAL word same element → REREAD ×2 (base)
  ...
  // Graham - Cross the T's: Slash weapons REREAD ×1
  if(hasCapstone('Graham Moor') && heroName === 'Graham Moor' && s.item && s.item.category === 'slash'){
    ...
    if(wordData){
      ...
      if(wantBreakdown) breakdown.base.push(`${fmtMod(wordData.apContribution, 'ap', ' AP')} ${weaponWord.name} <span class="mod-badge reread">REREAD</span> Cross the T's`);
  ...
  if(hasCapstone('Quivera') && heroName === 'Quivera' && allWords.length > 0){
    ...
    if(lastWord){
      ...
      if(wordData){
        ...
        if(wantBreakdown) breakdown.base.push(`${fmtMod(wordData.apContribution, 'ap', ' AP')} ${lastWord.name} <span class="mod-badge reread">REREAD</span> Count Cadence`);
        if(wantBreakdown && wordData.mult) breakdown.multipliers.push(`${fmtMod(wordData.mult,'scale')} ${lastWord.name} (Count Cadence)`);
      }
    }
  }

  // Caesura - Ellipsis: Words after an empty slot get ×2
  if(hasCapstone('Caesura') && heroName === 'Caesura'){
    // Check slots in order: adj1, adj2, weapon, adj3, adj4, noun1
    // If any slot is empty, subsequent words get ×2
    ...
    slotOrder.forEach(slotKey => {
      ...
      if(!word){
        ...
        // This word comes after an empty slot - retrigger it (×2 effect)
        const wordData = wordDataMap.get(word);
        if(wordData){
          retriggerAP += wordData.apContribution;
          retriggerWordCount += getWordCountForReread(wordData);
          ...
          if(wantBreakdown) breakdown.base.push(`${fmtMod(wordData.apContribution, 'ap', ' AP')} ${word.name} <span class="mod-badge reread">REREAD</span> Ellipsis`);
  ...
  // Belle Lettres - Knowledge Eternal: All words REREAD ×1
  if(hasCapstone('Belle Lettres') && heroName === 'Belle Lettres'){
    allWords.forEach(word => {
      ...
      if(wordData){
        ...
        if(wantBreakdown) breakdown.base.push(`${fmtMod(wordData.apContribution, 'ap', ' AP')} ${word.name} <span class="mod-badge reread">REREAD</span> Knowledge Eternal`);
  ...
  multiplicativeMult *= retriggerMult; // Apply retriggered word multipliers (e.g., Legendary ×1.5)

  // Track total REREADs and W bonuses for converter/threshold phases
  let totalRereadCount = retriggeredWords.length;
  let globalWBonus = 0;
  let totalWBonuses = 0; // Track +W bonuses for Residual converter
  ...
  const rereadAllWords = (talentName) => {
    ...
    allWords.forEach(word => {
      ...
      if(wordData){
        ...
        retriggeredWords.push({word, talent: talentName});
        newRereads++;
        if(wantBreakdown) breakdown.base.push(`${fmtMod(wordData.apContribution, 'ap', ' AP')} ${word.name} <span class="mod-badge reread">REREAD</span> ${talentName}`);
      }
    });
    return newRereads;
  };
  ...
  while(continueLoop && loopIteration < MAX_LOOP_ITERATIONS){
      ...
      if(newRereads > 0 || loopIteration === 1){
        ...
        if(wantBreakdown && bonus > 0){
          ...
          rereadCountByWord.forEach((count, word) => {
            ...
            breakdown.multipliers.push(`${fmtMod(wordBonus, 'word', ' W')} Echo Chamber (${word.name} ×${count})`);
          });
        }
      }
    }
    ...
    // Golden Tongue: Each 20 Gold held → +1 W - scales with level
    if(hasTalent('golden_tongue') && loopIteration === 1){
      const basePerStack = scaleTalentBonus('golden_tongue', 1);
      const bonus = Math.floor((S.gold || 0) / 20) * basePerStack;
      if(bonus > 0){
        globalWBonus += bonus;
        totalWBonuses += bonus;
        if(wantBreakdown) breakdown.multipliers.push(`${fmtMod(bonus, 'word', ' W')} Golden Tongue (${S.gold} Gold)`);
      }
    }
    ...
    if(hasTalent('lexicon_growth') && loopIteration === 1){
      ...
      const bonus = allWords.length * bossesDefeated * basePerWordPerBoss;
      if(bonus > 0){
        globalWBonus += bonus;
        totalWBonuses += bonus;
        if(wantBreakdown) breakdown.multipliers.push(`${fmtMod(bonus, 'word', ' W')} Lexicon Growth (${bossesDefeated} bosses)`);
      }
    }

    // Momentum: +1 W per Word per round played (max 10) - scales with level
    if(hasTalent('momentum') && loopIteration === 1){
      const roundsPlayed = Math.min((S.roundIndex || 1) - 1, 10);
      const basePerWordPerRound = scaleTalentBonus('momentum', 1);
      const bonus = allWords.length * roundsPlayed * basePerWordPerRound;
      if(bonus > 0){
        globalWBonus += bonus;
        totalWBonuses += bonus;
        if(wantBreakdown) breakdown.multipliers.push(`${fmtMod(bonus, 'word', ' W')} Momentum (${roundsPlayed} rounds)`);
      }
    }

    // Stony Brook: Water + Earth → +12 W (generator, run once) - scales with level
    if(hasTalent('stony_brook') && loopIteration === 1){
      if(hasElements(allWords, [E.WATER, E.EARTH])){
        const bonus = scaleTalentBonus('stony_brook', 12);
        globalWBonus += bonus;
        totalWBonuses += bonus;
        if(wantBreakdown) breakdown.multipliers.push(`${fmtMod(bonus, 'word', ' W')} Stony Brook`);
      }
    }

    // Word Hoard: Each word in inventory → +0.2 W (generator, run once) - scales with level
    if(hasTalent('word_hoard') && loopIteration === 1){
      const invCount = (S.inv || []).filter(w => !w.hiddenInBank).length;
      const basePerWord = scaleTalentBonus('word_hoard', 0.2);
      ...
      if(bonus > 0){
        globalWBonus += bonus;
        totalWBonuses += bonus;
        if(wantBreakdown) breakdown.multipliers.push(`${fmtMod(bonus, 'word', ' W')} Word Hoard (${invCount} Words)`);
      }
    }

    // Slow Burn: +2 W per round number (generator, run once) - scales with level
    if(hasTalent('slow_burn') && loopIteration === 1){
      const roundNum = (S.roundIndex || 1);
      const basePerRound = scaleTalentBonus('slow_burn', 2);
      const bonus = roundNum * basePerRound;
      globalWBonus += bonus;
      totalWBonuses += bonus;
      if(wantBreakdown) breakdown.multipliers.push(`${fmtMod(bonus, 'word', ' W')} Slow Burn (Round ${roundNum})`);
    }

    // Tithe: Each 20 Gold spent this run → +2 W (converter, run once) - scales with level
    if(hasTalent('tithe') && loopIteration === 1){
      ...
      if(stacks > 0){
        ...
        globalWBonus += bonus;
        totalWBonuses += bonus;
        if(wantBreakdown) breakdown.multipliers.push(`${fmtMod(bonus, 'word', ' W')} Tithe (${goldSpent} Gold spent)`);
      }
    }

    // Word Historian: Each Word used this run → +0.25 W (cumulative, run once) - scales with level
    if(hasTalent('word_historian') && loopIteration === 1){
      const wordsUsed = S.wordsUsedThisRun || 0;
      if(wordsUsed > 0){
        const basePerWord = scaleTalentBonus('word_historian', 0.25);
        const bonus = Math.floor(wordsUsed * basePerWord);
        if(bonus > 0){
          globalWBonus += bonus;
          totalWBonuses += bonus;
          if(wantBreakdown) breakdown.multipliers.push(`${fmtMod(bonus, 'word', ' W')} Word Historian (${wordsUsed} Words used)`);
        }
      }
    }

    // Reverberation: Each REREAD triggered this run → +2 W (cumulative, run once) - scales with level
    if(hasTalent('reverberation') && loopIteration === 1){
      const rereadsTriggered = S.rereadTriggersThisRun || 0;
      if(rereadsTriggered > 0){
        ...
        globalWBonus += bonus;
        totalWBonuses += bonus;
        if(wantBreakdown) breakdown.multipliers.push(`${fmtMod(bonus, 'word', ' W')} Reverberation (${rereadsTriggered} Rereads)`);
      }
    }

    // === NEW T1 FLAT W GENERATORS (run once) - all scale with level ===

    // Steady Hand: Always +3 W (T1 flat bonus)
    if(hasTalent('steady_hand') && loopIteration === 1){
      const bonus = scaleTalentBonus('steady_hand', 3);
      globalWBonus += bonus;
      totalWBonuses += bonus;
      if(wantBreakdown) breakdown.multipliers.push(`${fmtMod(bonus, 'word', ' W')} Steady Hand`);
    }

    // First Blood: Chapter 1 (Rounds 1-9) +10 W (T1 early game helper)
    if(hasTalent('first_blood') && loopIteration === 1){
      const roundNum = S.roundIndex || 1;
      if(roundNum <= 9){
        const bonus = scaleTalentBonus('first_blood', 10);
        globalWBonus += bonus;
        totalWBonuses += bonus;
        if(wantBreakdown) breakdown.multipliers.push(`${fmtMod(bonus, 'word', ' W')} First Blood (Ch.1)`);
      }
    }

    // Comfort Zone: Only 1 Element type in Forge → +6 W
    if(hasTalent('comfort_zone') && loopIteration === 1){
      const elementsInForge = new Set(allWords.filter(w => w.elem !== undefined).map(w => w.elem));
      if(elementsInForge.size === 1){
        const bonus = scaleTalentBonus('comfort_zone', 6);
        globalWBonus += bonus;
        totalWBonuses += bonus;
        if(wantBreakdown) breakdown.multipliers.push(`${fmtMod(bonus, 'word', ' W')} Comfort Zone`);
      }
    }

    // Linguist: 3+ Word types in Forge → +5 W
    if(hasTalent('linguist') && loopIteration === 1){
      const wordTypes = new Set(allWords.map(w => w.type));
      if(wordTypes.size >= 3){
        const bonus = scaleTalentBonus('linguist', 5);
        globalWBonus += bonus;
        totalWBonuses += bonus;
        if(wantBreakdown) breakdown.multipliers.push(`${fmtMod(bonus, 'word', ' W')} Linguist (${wordTypes.size} types)`);
      }
    }

    // Condensed: 3 or fewer Words in Forge → +8 W
    if(hasTalent('condensed') && loopIteration === 1){
      if(allWords.length <= 3){
        const bonus = scaleTalentBonus('condensed', 8);
        globalWBonus += bonus;
        totalWBonuses += bonus;
        if(wantBreakdown) breakdown.multipliers.push(`${fmtMod(bonus, 'word', ' W')} Condensed (${allWords.length} Words)`);
      }
    }

    // Spectrum: Per unique Element in Forge → +2 W
    if(hasTalent('spectrum') && loopIteration === 1){
      const elementsInForge = new Set(allWords.filter(w => w.elem !== undefined).map(w => w.elem));
      const basePerElement = scaleTalentBonus('spectrum', 2);
      const bonus = elementsInForge.size * basePerElement;
      if(bonus > 0){
        globalWBonus += bonus;
        totalWBonuses += bonus;
        if(wantBreakdown) breakdown.multipliers.push(`${fmtMod(bonus, 'word', ' W')} Spectrum (${elementsInForge.size} Elements)`);
      }
    }

    // Inferno: Fire + Water in Forge → +10 W
    if(hasTalent('inferno') && loopIteration === 1){
      if(hasElements(allWords, [E.FIRE, E.WATER])){
        const bonus = scaleTalentBonus('inferno', 10);
        globalWBonus += bonus;
        totalWBonuses += bonus;
        if(wantBreakdown) breakdown.multipliers.push(`${fmtMod(bonus, 'word', ' W')} Inferno`);
      }
    }

    // Verdant: Earth + Light in Forge → +10 W
    if(hasTalent('verdant') && loopIteration === 1){
      if(hasElements(allWords, [E.EARTH, E.LIGHT])){
        const bonus = scaleTalentBonus('verdant', 10);
        globalWBonus += bonus;
        totalWBonuses += bonus;
        if(wantBreakdown) breakdown.multipliers.push(`${fmtMod(bonus, 'word', ' W')} Verdant`);
      }
    }

    // Venom Strike: Poison + Lightning in Forge → +10 W
    if(hasTalent('venom_strike') && loopIteration === 1){
      if(hasElements(allWords, [E.POISON, E.LIGHTNING])){
        const bonus = scaleTalentBonus('venom_strike', 10);
        globalWBonus += bonus;
        totalWBonuses += bonus;
        if(wantBreakdown) breakdown.multipliers.push(`${fmtMod(bonus, 'word', ' W')} Venom Strike`);
      }
    }

    // Twilight: Dark + Physical in Forge → +10 W
    if(hasTalent('twilight') && loopIteration === 1){
      if(hasElements(allWords, [E.DARK, E.PHYS])){
        const bonus = scaleTalentBonus('twilight', 10);
        globalWBonus += bonus;
        totalWBonuses += bonus;
        if(wantBreakdown) breakdown.multipliers.push(`${fmtMod(bonus, 'word', ' W')} Twilight`);
      }
    }

    // Bibliophile: Per Word in Forge → +1 AP - scales with level
    if(hasTalent('bibliophile') && loopIteration === 1){
      ...
      if(bonus > 0){
        baseAP += bonus;
        if(wantBreakdown) breakdown.base.push(`${fmtMod(bonus, 'ap', ' AP')} Bibliophile (${allWords.length} Words)`);
      }
    }
    ...
    // Reread Amplifier: Each REREAD grants ×1.5 (stacking) - scales with level
    ...
    // Compound Interest: Each 50 Gold held → ×1.15 - scales with level
    if(hasTalent('compound_interest') && loopIteration === 1){
      ...
      if(stacks > 0){
        ...
        multiplicativeMult *= mult;
        if(wantBreakdown) breakdown.multipliers.push(`${fmtMod(mult, 'scale')} Compound Interest (${stacks}×50 Gold)`);
      }
    }

    // Overflow: Per 10 W above 50 → ×1.5 (stacks multiplicatively) - scales with level
    if(hasTalent('overflow') && loopIteration === 1){
      ...
      if(currentW > 50){
        ...
        if(stacks > 0){
          ...
          const mult = Math.pow(scaledMult, stacks);
          multiplicativeMult *= mult;
          if(wantBreakdown) breakdown.multipliers.push(`${fmtMod(mult, 'scale')} Overflow (${stacks}×10 W above 50)`);
        }
      }
    }
    ...
    if(hasTalent('crescendo') && nonCrescendoRereads >= 6 && !triggeredThresholds.has('crescendo_' + loopIteration)){
      ...
      if(wantBreakdown) breakdown.multipliers.push(`<span class="mod-badge reread">REREAD ×${newRereads}</span> Crescendo (${nonCrescendoRereads} non-Crescendo REREADs ≥ 6)`);
    }

    // Chain Reaction: 4+ REREADs → ×3 - scales with level
    if(hasTalent('chain_reaction') && totalRereadCount >= 4 && !triggeredThresholds.has('chain_reaction')){
      ...
      if(wantBreakdown) breakdown.multipliers.push(`${fmtMod(chainMult, 'scale')} Chain Reaction (${totalRereadCount} REREADs ≥ 4)`);
    }
  ...
  // ========================================
  // Scale from ×1.2 (1 talent) to ×2.0 (9+ talents)
  ...
  // ========================================
  // Formula: baseAP × wordCount × multiplicativeMult × talentCountMult
  ...
  if(hasTalent('execute') && !ultimateWeaponForged){
    ...
    if(remainingHP > 0 && remainingPercent <= 0.15){
      ...
      const countLabel = executeRereadCount > 1 ? ` ×${executeRereadCount}` : '';
      ...
      for(let i = 0; i < executeRereadCount; i++){
        allWords.forEach(word => {
          ...
          if(wordData){
            ...
            if(wantBreakdown) breakdown.base.push(`${fmtMod(wordData.apContribution, 'ap', ' AP')} ${word.name} <span class="mod-badge reread">REREAD</span> Execute`);
          }
        });
      }
  ...
  if(S.chapterBoss && S.chapterBoss.id === 'cinna_antony' && !bossAbilityDisabled){
    ...
    if(elemsInWeapon.length > 0){
      ...
      if(!allSameElement && !allOppositePairs){
        ...
        breakdown.multipliers.push(`<span style="color:#4ade80">Cinna & Antony: ${reason} ✓</span>`);
      }
    }
  }
...
async function forge(){
  ...
  if(hasGem){
    ...
    // Gem / suffix element appears after post‑adjectives
...
async function afterCombat(){
  ...
  if(lastResult.win){
    ...
    // Hyperbole: Overkill ×2 carries to next round (capped at 25% of enemy max HP) - scales with level
    ...
    if(isChapterBoss){
      ...
      await showTalentSelect(3, 1); // Miniboss: 3 choices, pick 1
    } else {
...
async function showTalentSelect(numChoices = 5, numPicks = 2){
  // Pick random talents that the player doesn't already have
  // Miniboss: 3 choices, pick 1 | Chapter Boss: 5 choices, pick 2
    ...
    choices.forEach((talent, index) => {
      ...
      if(talent.desc){
        ...
        if(descLower.includes('per round')){
          ...
          const badge = fmtMod(bonus, 'word', ' W');
          const levelText = getTalentLevel('momentum') > 1 ? ` (Lv.${getTalentLevel('momentum')})` : '';
          accumulatedTotal = `<div style="font-size:10px;margin-top:6px">${roundsPlayed} rounds played: ${badge}/Word${levelText}</div>`;
          ...
          if(baseW > 50){
            ...
            const mult = Math.pow(1.5, stacks);
            const multRound = Math.round(mult * 100) / 100;
            accumulatedTotal = `<div style="font-size:10px;margin-top:6px;color:#4ade80">~${baseW} W: ${stacks} stacks = <span class="mod-badge scale">×${multRound}</span></div>`;
          } else {
          ...
          try {
            ...
            if(value > 1){
              const v = Math.round(value * 10) / 10;
              accumulatedTotal = `<div style="font-size:10px;margin-top:6px;color:#4ade80">Active now: <span class="mod-badge scale">×${v}</span></div>`;
            } else {
      ...
      card.innerHTML = `
        <div class="talent-card-inner">
          ...
          <div class="talent-card-face talent-card-back tier-${talent.rarity === 'rare' ? '3' : talent.rarity === 'uncommon' ? '2' : '1'}">
            ...
            <div class="talent-card-desc">${formatTalentDesc(talent)}</div>
            ${accumulatedTotal}
      ...
      card.onclick = async () => {
        ...
        // Play selection sound (E minor: E5 -> B5)
        try{
          playTone(659, 0.3, 'sine', 0.2);
          setTimeout(() => playTone(988, 0.2, 'sine', 0.15), RHYTHM.QUARTER);
        }catch(err){}
    ...
    upgradeBtn.onclick = async () => {
      ...
      swapCards.forEach(card => {
        ...
        card.onclick = async () => {
          ...
          const picksRemaining = maxPicks - selectedTalents.length;
          if (picksRemaining > 0) {
            // Fade out and return to talent selection
            container.style.transition = "opacity 0.3s ease";
            container.style.opacity = "0";
            await dly(RHYTHM.HALF);
            container.style.opacity = "1";
    ...
    if(r.win){
      ...
      if(resultDetail){
        ...
        if(rewards && rewards.gold > 0){
          ...
          goldLine.innerHTML = `<span class="gold">+${rewards.gold} Gold</span>`;
...
async function showShop(skipTransition = false){
  ...
  S.rerollCost=5;
  // Base crate price scaled by difficulty (25 → 31 → 38 for Adept/Master)
  ...
  if(heroInfo){
    if(!S.hero){
      ...
      const badProfHtml = hasOvercoming
        ? `<span class="tag prof">${badProf} ×1.5 W</span>`
        : `<span class="tag weak">${badProf} ×0.5 W</span>`;
      heroInfo.innerHTML =
        ...
        `<div><span class="dim" style="font-size:10px">Proficient:</span> <span class="tag prof">${goodProf} ×2 W</span> ${badProfHtml}</div>`;
    }
  }
...
function renderShopCrates(){
  ...
  shopCrates.forEach((crate, i) => {
    ...
    const crateIcons = {
      world_sky: {icon: icon('earth-sky'), color: '#4ade80', subtitle: 'Fire • Water • Earth • Lightning'},
      body_soul: {icon: icon('body-soul'), color: '#a78bfa', subtitle: 'Physical • Poison • Light • Dark'}
    };
...
function renderShopWordBank(animate = true){
  ...
  sorted.forEach((word) => {
    ...
    if(word.elem !== undefined){
      ...
      // Non-elemental words (Common->Legendary adjectives) show multiplier as a badge with mono font
      elemHtml = `<span class="mod-badge scale" style="margin-top:2px;font-size:9px">×${word.mult}</span>`;
    }
    ...
    // Determine display name using the base (noun) form for non‑weapons to match forge naming.
...
function renderShopTalents(){
  ...
  viewBtn.textContent = "👁️ View All";
...
function showInv(){
  ...
  sorted.forEach(w=>{
    ...
    // Use base (noun) form for non‑weapons
    let displayName = w.name;
    if(w.type !== 'weapon' && !w.isStick){
      displayName = getDisplayForm(w, 'noun1', null) || w.name;
    }
    ...
    let elemHtml = w.elem !== undefined
      ...
      : (w.mult && w.mult !== 1 ? `<span class="mult-pill">×${w.mult}</span>` : "");
 ...
 * Shows: Name (rarity colored) + Tier - Element (or ×mult for non-elemental)
 */
function formatReelItem(word) {
  ...
  if (word.elem !== undefined) {
    ...
    detailHtml = `<span class="reel-mult">×${word.mult}</span>`;
  }
